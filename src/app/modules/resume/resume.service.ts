...
//  */
// export async function createResumeService(userId: number, payload: ResumePayload) {
//    // Validate required fields
//    console.log(payload, "resume payload")
...
//                     ...rest,
//                     technologies: rest.technologies, // now valid String[]
//                  })),
//               }
//             : undefined,
...
//  */
// export async function getResumeService(userId: number) {
...
//  */
// export async function updateResumeService(userId: number, payload: Partial<ResumePayload>) {
//    // Get existing resume
...
//  */
// export async function deleteResumeService(userId: number) {
...
//  */
// export async function resumeExists(userId: number): Promise<boolean> {
//    const resume = await prisma.resume.findUnique({
//       where: { userId },
//       select: { id: true },
//    });
...
// services/resumeService.ts (Fixed)

// services/resumeService.ts (All TypeScript Errors Fixed)
